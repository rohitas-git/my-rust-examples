...
pub mod iterator_consumers{
    ...
    /// or returns false if the closurereturns false for all the items.
    /// 
    pub mod any{
        fn determin_a_char(s:&str,ch:char){
            // let s = "Hello, world!";
            // let ch = 'R';
            let mut contains = false;
            for c in s.chars() {if c == ch {contains = true;}}
            print!("\"{}\" {} '{}'.",s,if contains {"contains"} else {"does not contain"}, ch);
        }
        pub fn determin_a_char_with_any(s:&str,ch:char){
            // let s = "Hello, world!";
            // let ch = 'R';
            println!("\"{}\" {} '{}'.",s, if s.chars().any(|c| c == ch) {"contains"} else {"does not contain"}, ch);
        }
