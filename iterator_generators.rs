...
fn main(){
    ...
    string_iterator::iterator_over_string_char("ۏe", 4);
    string_iterator::print_codes("ۏe");
    string_iterator::for_loop_iterator_over_string_char("Rohitas.,&^5%->Bansal");
...
pub mod string_iterator{
    ...
    pub fn iterator_over_string_char(s: &str, mut n: u32) {
    ...
    pub fn for_loop_iterator_over_string_char(s:&str){
        for c in s.chars() {
            println!("{}: {}", c, c as u32);
        }
    }
